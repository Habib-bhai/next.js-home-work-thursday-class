             ...
             <div className="h-full w-screen flex flex-col gap-20 justify-center items-center mt-16 md:px-[10rem] overflow-x-hidden">
                <div className=" md:h-screen md:w-full h-auto w-full flex md:flex-nowrap flex-wrap md:gap-8 justify-center items-center ">
                    ...
                    <div className="img overflow-hidden rounded-2xl">
                        <Image src={"/shoes.jpg"} alt="shoes" width={500} height={500} className="h-64 w-72 md:w-[500px] md:h-[400px] transition transform duration-500 ease-out hover:scale-125 rounded-2xl " />
                    </div>
                    ...
                    <div className="img overflow-hidden rounded-2xl">
                        <Image src={"/hoodies.jpeg"} alt="shoes" width={500} height={500} className="h-64 w-72 md:w-[500px] md:h-[500px] transition transform duration-500 ease-out hover:scale-125 rounded-2xl " />
                    </div>
                    <div>
